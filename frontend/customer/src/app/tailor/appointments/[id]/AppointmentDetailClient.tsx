...
export default function AppointmentDetailClient({ id }: AppointmentDetailClientProps) {
    ...
    const handleCreateOrder = () => {
        router.push(`/tailor/orders/create?appointment_id=${id}&customer_id=${appointment?.customer_id}`);
    };
